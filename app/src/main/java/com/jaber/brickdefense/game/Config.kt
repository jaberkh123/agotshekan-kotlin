...
object Cfg {
    ...
    val HOUSES_GUIDE: Map<String, Guide> = mapOf(
        "jelly" to Guide(
            ...
            "این خانه در برابر توپ انفجاری (بمب) کاملاً مصون است — نه ضربه مستقیم به آن می‌خورد نه پاشش انفجار! توپ برقی به آن نصف آسیب می‌زند و خانه‌های ژله‌ای هیچ‌وقت نفرین نمی‌شوند؛ برای شکستنش از توپ معمولی یا روحی استفاده کن."
        ),
        "stone" to Guide(
            "img/ston1.png", "خانه سنگی ⚪",
            "بسیار مقاوم است؛ توپ برقی از روی آن عبور نمی‌کند و در اولین برخورد متوقف می‌شود. توپ بمب به آن ۲ برابر آسیب می‌زند — برای شکستنش از توپ انفجاری استفاده کن! وقتی در حال نشانه‌گیری با توپ انفجاری باشی، با آلارم قرمز مشخص می‌شود. هنگام نشانه‌گیری با توپ برقی هم زنجیره‌های بزرگ (بیش از ۶ خانه چسبیده) با آلارم قرمز مشخص می‌شوند."
        ),
        "healer" to Guide(
            "img/ston1.png", "درمانگر 🟢",
            "هر ترن دشمنان کناری (چپ و راست خودش) را شفا می‌دهد — اولویت اول تو برای نابودی باید او باشد!"
        ),
        "splitter" to Guide(
            "img/ston1.png", "شکافتی 🔷",
            "وقتی نابودش می‌کنی به دو ذرّه کوچک تقسیم می‌شود که جای خودش ظاهر می‌شوند."
        ),
        "iron" to Guide(
            "img/iron1.png", "خانه آهنی 🔵",
            "بسیار مقاوم است؛ عبورش از خط دفاع ۲ جان کم می‌کند. گلوله روحی را می‌بلعد و محو می‌شود. اگر توپ برقی مستقیم به آن بخورد، برق قرمزِ فوری به همه‌ی خانه‌های صفحه می‌خورد!"
        ),
        "hole" to Guide(
            "img/bos2.png", "سیاهچاله 🕳",
            "در حال چرخش است؛ توپ‌های معمولی با برخورد به آن محو می‌شوند (بدون انعکاس و بدون آسیب)! برای شکستنش از توپ انفجاری، روحی یا برقی استفاده کن."
        )
    )
    ...
    val ENEMIES: Map<String, EnemyDef> = mapOf(
        ...
        "jelly" to EnemyDef(
            ...
            desc = "ضربه اول را نیمه جذب می‌کند؛ مصون از بمب و نفرین؛ توپ برقی به آن نصف آسیب می‌زند"
        ),
        "stone" to EnemyDef(
            "stone", "سنگی", "#90a4ae", 5.5, 14, 1, 4, 1, crackAt = 0.5,
            desc = "مقاوم؛ توپ برق از آن عبور نمی‌کند؛ با توپ انفجاری آلارم قرمز می‌گیرد"
        ),
        "healer" to EnemyDef(
        ...
        "iron" to EnemyDef(
            ...
            desc = "بسیار مقاوم؛ عبورش = ۲ ❤️-؛ گلوله روحی را می‌بلعد؛ توپ برق را واکنش سراسری می‌دهد"
        ),
        "splitter" to EnemyDef(
            "splitter", "شکافتی", "#5c6bc0", 3.3, 10, 6, 3, 1, split = true,
            desc = "با مرگ به دو تکه کوچک تقسیم می‌شود"
        ),
        "hole" to EnemyDef(
            "hole", "سیاهچاله", "#3e2765", 3.5, 18, 99, 0, 2, hole = true,
            desc = "در حال چرخش؛ توپ‌های معمولی را می‌بلعد (محو می‌شوند)؛ از مرحله ۲۰ با شانس ۵٪"
        ),
        "mini" to EnemyDef("mini", "ذرّه", "#7986cb", 0.4, 3, 99, 0, 1),
        "boss" to EnemyDef(
            "boss", "دژخیم", "#6a1b9a", 8.8, 60, 99, 0, 5, boss = true,
            shieldEvery = 3, shieldTime = 0.9,
            desc = "رئیس! هر ۱۰ ترن یک‌بار می‌آید (ترن ۱۰ و ۲۰ و ۳۰...)؛ هر ۳ ضربه سپر می‌شود؛ عبورش ۵ ❤️-"
        )
    )
}
